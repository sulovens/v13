...
//BASE ORI MHANKBARBAR😇
//MAU RECODE SC? RECODE AJA TAPI JANGAN LUPA NAMA SAYA 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏
...
const dtod = "628979401640@s.whatsapp.net"

const otod = "628979401640@s.whatsapp.net"
const ktod = "628979401640@s.whatsapp.net"

const htod = "628979401640@s.whatsapp.net"
...
module.exports = simple = async (simple, mek, _welkom) => {
	try {
		...
		const ownerNumber = [`${owner}@s.whatsapp.net`, `628979401640@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		faketeks = '©𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏' //Ganti Aja Nama Luh
		const isUrl = (url) => {
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = simple.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "List HELIX BOT","footerText": `_HELLO KAK_ >.<
✋ 
...
//>>>>>>>>>>>>>>>>>>>>>[ BUTTON TAMBAHAN ]<<<<<<<<<<<<<<<<<<<<<<<\\
        ...
        const jelek = { "title": `Hallo ${pushname}`,"body": `hy`, "mediaType": "2", "mediaUrl": "https://m.youtube.com/c/AurelGaming", "thumbnail": fs.readFileSync('./poto/YENI.jpg')}
...
Ppurl = 'https://i.ibb.co/28jRxWz/Pics-Art-04-20-04-49-07.jpg'
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
   ...
   sendButImage(from, pll, `HELIX BOT © 2022`, cewe, [                      
          {
...
[`sholawat1`,`sholawat2`,`sholawat3`,`sholawat4`,`sholawat5`,`sholawat6`,`sholawat7`,`sholawat8`,`sholawat9`,] 
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: 'HELIX BOT  🅥 ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe HELIX BOT`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `©_HELIX BOT_ *V : 2.889H*`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
simple.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe HELIX BOT' })
fs.unlinkSync(ran)
})
break
...
simple.sendMessage(`628979401640@s.whatsapp.net`, options, text, { quoted: ftrol })
...
ᥒႸ⍺rі рᥣр рᥱr⍺k⍺ᥒ ᥒ tut𝘰r 𝗆ur𝗆ᥱr?Ⴘukk 𝗆⍺𝗆ріr 𝖽і DTM.G𝘚t𝘰rᥱ😋💘
...
˖࣪ ϟ ִֶָ𝐍𝐎𝐓𝐄 :
❀┊pɑyოеიt DANA იо 𝗋еff,kc𝗎ɑIі sIɑһ ɑⅾოіი
❀┊p𝗋оsеs fɑst
❀┊о𝗋ⅾе𝗋?sbɑ𝗋 yɑ
❀┊bе ɑ sოɑ𝗋t b𝗎yyе𝗋 
❀┊cоpy Iіst?ⅾеიⅾɑ+𝗏і𝗋ɑI y
*MAU BUY JASA? PILIH BUTTON 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏 DI BAWAH*
─`
but = [
{ buttonId: `${prefix}bear`, buttonText: { displayText: 'HELIX BOT😘' }, type: 1 }, 
...
*🌻250k - 600k : 20k*
*🌻600k - 1JT : 50k*
*MAU BUY JASA ADMIN? PILIH BUTTON 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏
 DI BAWAH*
─`
but = [
...
*JOIN GRUB JB DTM.GSTORE KAWAN : https://chat.whatsapp.com/HAZ6yFgCafUAeDbNH33IrL*

*ADMIN 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏 MENYEDIAKAN :*
📢 GOBER
📢 OVOBER
📢 DANABER
📢 JASA CR 2k
...
📍RAGU? Cek IG dtm.gstore
📍BE SMART BUYER 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏
─`
but = [
...
︎☂︎Link http://⁹+I/628979401640?text=BG+MAU+SEWA+BOT: **
   `
but = [
...
sendButton(from, "GOPAY : 08979401640", faketeks, but, mek)
break
case 'dana':
simple.updatePresence(from, Presence.recording)
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
...
sendButton(from, "DANA : 0852", faketeks, but, mek)
break
case 'ovo':
simple.updatePresence(from, Presence.recording)
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
...
sendButton(from, "OVO : 08979401640", faketeks, but, mek)
break
...
simple.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏'})
break
case 'hijaber':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
...
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
simple.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏'})
break
case 'ukhti':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
...
reply('TUHH NOMER 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏 SUNG TARIK KE GRUP BER²')
break
           ...
           case 'cup':
            ...
            if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
                    ...
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${humankey}&text=${ini_txt}`).then((gambar) => {
                        simple.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `©𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏 IMAGE`, quoted : fgif})
                    })
                    break
                case 'arcade8bit':
                case 'battlefield4':
...
Sendbutdocument(from, tescok, "© 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏*", fs.readFileSync('./poto/menu.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./poto/image/thumbnaildokumen.jpg'), filename:`𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏.pdf`, pageCount: 9999999 },[{ buttonId: `${prefix}menu`, buttonText: { displayText: '🐣OWNER🐣' }, type: 1 }], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/x-O0WHkv3uc`}}})
break
...
but = [
        ...
        sendButImage(from, kimak, "© 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏", img, but)
break
...
simple.updatePresence(from, Presence.recording)
Gtau = 'https://i.ibb.co/RPM2VTg/Pics-Art-04-20-04-49-07.jpg'
...
simple.updatePresence(from, Presence.recording)
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
anu = 'https://i.ibb.co/5MxwQJV/Screenshot-20220122-120934.png'
...
reply('```W A I T I N G```')
                nama = ' 🔥𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏🔥 '
       ownerJid = "628979401640@s.whatsapp.net"
                nomor = 1
                itod = `${sender}`
...
tescok = `❏  _*Runtime : ${runtime(process.uptime())}*_
  ...
  「 BAILEYS SELF-BOT」 `
Sendbutdocument(from, tescok, "© 𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏*", fs.readFileSync('./poto/menu.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./poto/image/thumbnaildokumen.jpg'), filename:`𝙃𝙀𝙇𝙄𝙓 𝘽𝙊𝙏.pdf`, pageCount: 9999999 },[{ buttonId: `${prefix}menu`, buttonText: { displayText: 'SIP,KAK😁' }, type: 1 }], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/WP66OsAf1W0`}}})
break

case 'sc':
simple.updatePresence(from, Presence.recording)
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgif})
url =  'https://i.ibb.co/RPM2VTg/Pics-Art-04-20-04-49-07.jpg'
